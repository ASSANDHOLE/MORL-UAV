...
class GymUav(gym.Env):
    def __init__(self, size_len=100.0, obs_interval=20.0,
                 ...
                 r_free=0.1, r_step=-0.3, sensor_max_dist=25.0, reward_params=None):
        ...
        # [theta, speed]
        self.action_space = gym.spaces.Box(np.array([-0.25, 0.5], dtype=np.float32), np.array([0.25, 3.5], dtype=np.float32))
